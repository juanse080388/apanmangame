document.addEventListener("DOMContentLoaded", () => {
  ...
  const orden = ["amarillo","azul","rojo"];
  let paso = 0;
    ...
    colorEl.addEventListener("click", async () => {
      ...
      if(color === orden[paso]){
        ...
        if(paso < orden.length){
          ...
          setTimeout(()=> window.location.href = "../niveles/nivel2.html",1000);
        }

      } else {
        // Error: no felicitar, solo pedir mismo color
        seleccionable = false;
